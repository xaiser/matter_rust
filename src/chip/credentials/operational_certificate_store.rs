...
pub trait OperationalCertificateStore {
    ...
    fn has_certificate_for_fabric(&self, fabric_index: FabricIndex, element: CertChainElement) -> bool;
    fn add_new_trusted_root_cert_for_fabric(&mut self, fabric_index: FabricIndex, rcac: &[u8]) -> ChipErrorResult;
    fn add_new_op_certs_for_fabric(&mut self, fabric_index: FabricIndex, noc: &[u8], icac: &[u8]) -> ChipErrorResult;
    fn update_op_certs_for_fabric(&mut self, fabric_index: FabricIndex, noc: &[u8], icac: &[u8]) -> ChipErrorResult;
    ...
    fn get_certificate(&self, fabric_index: FabricIndex, out_certificate: &mut [u8]) -> ChipErrorResult;
}
